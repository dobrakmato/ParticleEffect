...
public enum ParticleEffect {
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, isLongDistance(center, players), null).sendTo(
            center, players);
    }
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, isLongDistance(center, players), data).sendTo(
            center, players);
    }
